...
// lambda/auth/refresh-token/index.ts
...
var getSessionByRefreshToken = async (refreshToken) => {
...
var rotateRefreshToken = async (userId, sessionId, email) => {
...
var refreshSchema = import_joi.default.object({
  refreshToken: import_joi.default.string().required()
});
