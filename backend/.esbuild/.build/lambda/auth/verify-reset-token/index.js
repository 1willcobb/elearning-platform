...
var verify_reset_token_exports = {};
__export(verify_reset_token_exports, {
  handler: () => handler
});
module.exports = __toCommonJS(verify_reset_token_exports);
...
var verifySchema = import_joi.default.object({
