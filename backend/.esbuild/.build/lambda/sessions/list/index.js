...
var getUserSessions = async (userId) => {
...
var cleanupExpiredSessions = async (userId) => {
  ...
  if (expiredSessions.length > 0) {
    const deletePromises = expiredSessions.map(
      (session) => revokeSession(userId, session.sessionId)
    );
