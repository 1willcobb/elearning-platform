...
// lambda/schools/update/index.ts
var update_exports = {};
...
var requireAdmin = (handler2) => {
  return withAuth(handler2, ["ADMIN" /* ADMIN */, "SUPER_ADMIN" /* SUPER_ADMIN */]);
};

// lambda/schools/update/index.ts
var docClient = getDynamoDBClient();
var tableName = getTableName();
var updateSchoolSchema = import_joi.default.object({
  name: import_joi.default.string().min(3).max(100).optional(),
  description: import_joi.default.string().min(10).max(500).optional(),
...
var handlerLogic = async (event) => {
  try {
    ...
    const isSuperAdmin = event.user.roles.includes("SUPER_ADMIN" /* SUPER_ADMIN */);
    ...
    attributeValues[":updatedAt"] = (/* @__PURE__ */ new Date()).toISOString();
...
var handler = requireAdmin(handlerLogic);
