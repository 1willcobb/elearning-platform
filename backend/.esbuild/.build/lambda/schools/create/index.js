...
// lambda/schools/create/index.ts
var create_exports = {};
...
var requireUser = (handler2) => {
  return withAuth(handler2);
};
...
var handlerLogic = async (event) => {
  try {
    ...
    const currentRoles = event.user.roles || ["USER" /* USER */];
...
var handler = requireUser(handlerLogic);
