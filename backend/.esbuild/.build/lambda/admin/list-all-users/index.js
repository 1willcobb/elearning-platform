...
// lambda/admin/list-all-users/index.ts
var list_all_users_exports = {};
__export(list_all_users_exports, {
  handler: () => handler
});
module.exports = __toCommonJS(list_all_users_exports);
...
var handlerLogic = async (event) => {
  try {
    ...
    const result = role ? await docClient.send(new import_lib_dynamodb2.QueryCommand(queryParams)) : await docClient.send(new import_lib_dynamodb2.QueryCommand({
      ...queryParams,
      IndexName: "GSI1",
