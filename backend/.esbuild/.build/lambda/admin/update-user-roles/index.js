...
// lambda/admin/update-user-roles/index.ts
...
var updateRolesSchema = import_joi.default.object({
  userId: import_joi.default.string().required(),
  roles: import_joi.default.array().items(import_joi.default.string().valid(...Object.values(UserRole))).min(1).required()
});
