...
// lambda/admin/manual-enroll/index.ts
var manual_enroll_exports = {};
__export(manual_enroll_exports, {
  handler: () => handler
});
module.exports = __toCommonJS(manual_enroll_exports);
...
var enrollSchema = import_joi.default.object({
  userId: import_joi.default.string().required(),
  courseId: import_joi.default.string().required(),
  amountPaid: import_joi.default.number().min(0).default(0),
  currency: import_joi.default.string().default("USD")
});
