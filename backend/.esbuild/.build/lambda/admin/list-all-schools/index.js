...
// lambda/admin/list-all-schools/index.ts
var list_all_schools_exports = {};
__export(list_all_schools_exports, {
  handler: () => handler
});
module.exports = __toCommonJS(list_all_schools_exports);
...
var handlerLogic = async (event) => {
  try {
    ...
    const result = await docClient.send(new import_lib_dynamodb2.QueryCommand(queryParams));
