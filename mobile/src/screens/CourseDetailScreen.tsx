    ...
    <View style={{ flex: 1, backgroundColor: 'white' }}>
      <ScrollView>
        ...
        <View style={{ padding: 16 }}>
          ...
          {/* Stats */}
          <View style={{ flexDirection: 'row', justifyContent: 'space-between', marginBottom: 24, paddingBottom: 24, borderBottomWidth: 1, borderBottomColor: '#e5e7eb' }}>
      ...
      {/* Enroll Button */}
      <View style={{ padding: 16, borderTopWidth: 1, borderTopColor: '#e5e7eb', backgroundColor: 'white' }}>
        <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', marginBottom: 12 }}>
          <View>
            ...
            <Text style={{ fontSize: 32, fontWeight: 'bold', color: '#0284c7' }}>
        ...
        <TouchableOpacity
          ...
          style={{
            backgroundColor: isEnrolled ? '#6b7280' : '#0284c7',
            paddingVertical: 16,
            borderRadius: 8,
            alignItems: 'center',
          }}
        >
          <Text style={{ color: 'white', fontWeight: 'bold', fontSize: 18 }}>
            {enrollMutation.isPending ? 'Enrolling...' : isEnrolled ? 'Enrolled ✓' : 'Enroll Now'}
          </Text>
        </TouchableOpacity>
      </View>
    </View>
